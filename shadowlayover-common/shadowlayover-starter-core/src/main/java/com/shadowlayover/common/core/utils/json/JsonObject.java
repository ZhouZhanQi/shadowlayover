...
public class JsonObject implements Iterable<Map.Entry<String, Object>>, Serializable {
     ...
     */
    public JsonObject() {
        objectMap = Maps.newLinkedHashMap();
    }
    ...
    public <T> T mapTo(Class<T> type) {
        return Json.MAPPER.convertValue(objectMap, type);
    }
    ...
    public String getString(String key) {
        ...
        CharSequence cs = (CharSequence) objectMap.get(key);
    ...
    public Integer getInteger(String key) {
        ...
        Number value = numberConverter.convert(objectMap.get(key), null);
    ...
    public Long getLong(String key) {
        Objects.requireNonNull(key);
        final NumberConverter numberConverter = new NumberConverter(Long.class);
        Number value = numberConverter.convert(objectMap.get(key), null);
    ...
    public Float getFloat(String key) {
        Objects.requireNonNull(key);
        final NumberConverter numberConverter = new NumberConverter(Float.class);
        Number value = numberConverter.convert(objectMap.get(key), null);
    ...
    public Boolean getBoolean(String key) {
        Objects.requireNonNull(key);
        return new BooleanConverter().convert(objectMap.get(key), null);
    }
    ...
    public byte[] getBinary(String key) {
        Objects.requireNonNull(key);
        String encoded = (String) objectMap.get(key);
    ...
    public String getString(String key, String def) {
        Objects.requireNonNull(key);
        CharSequence cs = (CharSequence) objectMap.get(key);
        return cs != null || objectMap.containsKey(key) ? cs == null ? null : cs.toString() : def;
    }
    ...
    public Integer getInteger(String key, Integer def) {
        Objects.requireNonNull(key);
        Number val = (Number) objectMap.get(key);
        if (val == null) {
    ...
    public Boolean getBoolean(String key, Boolean def) {
        Objects.requireNonNull(key);
        Object val = objectMap.get(key);
        return val != null || objectMap.containsKey(key) ? (Boolean) val : def;
    }
    ...
    public JsonObject getJsonObject(String key, JsonObject def) {
        ...
        return val != null || objectMap.containsKey(key) ? val : def;
    }
    ...
    public byte[] getBinary(String key, byte[] def) {
        Objects.requireNonNull(key);
        Object val = objectMap.get(key);
        return val != null || objectMap.containsKey(key) ? (val == null ? null : Base64.getDecoder().decode((String) val)) : def;
    }
    ...
    public Instant getInstant(String key, Instant def) {
        Objects.requireNonNull(key);
        Object val = objectMap.get(key);
        return val != null || objectMap.containsKey(key) ?
     ...
     * <p>
     * JSON has no concept of encoding Enums, so the Enum will be converted to a String using the {@link Enum#value}
    ...
    public JsonObject put(String key, Enum value) {
        Objects.requireNonNull(key);
        objectMap.put(key, value == null ? null : value.name());
        return this;
    }
    ...
    public JsonObject put(String key, CharSequence value) {
        Objects.requireNonNull(key);
        objectMap.put(key, value == null ? null : value.toString());
        return this;
    }
    ...
    public JsonObject put(String key, byte[] value) {
        Objects.requireNonNull(key);
        objectMap.put(key, value == null ? null : Base64.getEncoder().encodeToString(value));
        return this;
    }
    ...
    public JsonObject put(String key, Instant value) {
        Objects.requireNonNull(key);
        objectMap.put(key, value == null ? null : ISO_INSTANT.format(value));
        return this;
    }
    ...
    public JsonObject mergeIn(JsonObject other, int depth) {
        ...
        if (depth == 1) {
            objectMap.putAll(other.objectMap);
            return this;
        }
        for (Map.Entry<String, Object> e : other.objectMap.entrySet()) {
            objectMap.merge(e.getKey(), e.getValue(), (oldVal, newVal) -> {
    ...
    public String encodePrettily() {
        return Json.encodePrettily(objectMap);
    }
    ...
    public JsonObject copy() {
        ...
        if (objectMap instanceof LinkedHashMap) {
            copiedMap = new LinkedHashMap<>(objectMap.size());
        } else {
            copiedMap = new HashMap<>(objectMap.size());
        }
    ...
    public Iterator<Map.Entry<String, Object>> iterator() {
        return new Iter(objectMap.entrySet().iterator());
    }
    ...
    public boolean equals(Object o) {
        ...
        return objectEquals(objectMap, o);
    }
    
    static boolean objectEquals(Map<?, ?> m1, Object o2) {
        Map<?, ?> m2;
        if (o2 instanceof JsonObject) {
            m2 = ((JsonObject) o2).objectMap;
    ...
    static boolean equals(Object o1, Object o2) {
        ...
        if (o1 instanceof JsonObject) {
            return objectEquals(((JsonObject) o1).objectMap, o2);
        }
    ...
    private void fromJson(String json) {
        objectMap = Json.decodeValue(json, Map.class);
    }
