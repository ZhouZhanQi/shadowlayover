...
public class TtlThreadContextMap implements ThreadContextMap {
    ...
    public Map<String, String> getCopy() {
        return MapUtils.isEmpty(localMap.get()) ? Maps.newHashMap() : Maps.newHashMap(localMap.get());
    }
    ...
    public boolean isEmpty() {
        return MapUtils.isEmpty(localMap.get());
    }
    
    @Override
    public void put(String key, String value) {
        Map<String, String> map = localMap.get();
        map = MapUtils.isEmpty(map) ? Maps.newHashMap() : Maps.newHashMap(map);
        map.put(key, value);
