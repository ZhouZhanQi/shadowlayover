...
public class RedisConfiguration {
    ...
    public RedisCacheManager redisCacheManager(LettuceConnectionFactory lettuceConnectionFactory) {
        ...
        ShadowlayoverRedisCacheManager redisCacheManager = new ShadowlayoverRedisCacheManager(cacheRedisCaffeineProperties, redisCacheWriter, redisCacheConfiguration);
